...
const navigationConfig = [
  ...
  },
  {
    ...
    children: [
      {
        id: 'schedule.lessons',
        title: 'Lessons',
        subtitle: '12 lessons this week',
        type: 'item',
        icon: 'material-outline:flight_takeoff',
        url: '/apps/calendar',
        translate: "Lessons",
        badge: {
          title: '3 today',
          classes: 'px-8 bg-orange-600 text-white rounded',
        },
      },
      {
        id: 'schedule.students',
        title: 'Students',
        subtitle: '3 lessons today, 12 lessons this week',
        type: 'item',
        icon: 'heroicons-outline:user-circle',
        url: '/apps/student-calendar',
      },
      {
        id: 'schedule.aircract',
        title: 'Aircraft',
        subtitle: '3 lessons today, 12 lessons this week',
        type: 'item',
        icon: 'material-outline:airplanemode_active',
        url: '/apps/aircraft-calendar',
      }, 
      {
        id: 'schedule.maintenance',
        title: 'Maintenance',
        subtitle: '1 upcoming event',
        type: 'item',
    ...
    badge: {
      title: '4',
      classes: 'px-2 bg-orange-600 text-white rounded',
    },
  },
  {
    id: 'students',
  ...
  
  {
    ...
    subtitle: 'Administration Resources',
    type: 'group',
    icon: 'material-outline:manage_accounts',
