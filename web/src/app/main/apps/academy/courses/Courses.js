        ...
        >
          <div className="flex flex-col items-center justify-center  mx-auto w-full">
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1, transition: { delay: 0 } }}>
              ...
              >
                Enhanced online ground school platform
              </Typography>
            </motion.div>
            <motion.div
              initial={{ opacity: 0 }}
            ...
            >
              ...
              >
                Our courses will step you through the process of learing the fundamentals of aviation, safety, and regulations preparing you for your FAA written exam.
              </Typography>
            </motion.div>
          </div>
