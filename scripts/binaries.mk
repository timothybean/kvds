...
RUN GOOS=windows GOARCH=amd64 go build -ldflags "-X github.com/noranetworks/kvds/internal/core.version=$$VERSION" -o tmp/$(BINARY_NAME).exe
...
RUN GOOS=linux GOARCH=amd64 go build -ldflags "-X github.com/noranetworks/kvds/internal/core.version=$$VERSION" -o tmp/$(BINARY_NAME)
...
RUN GOOS=darwin GOARCH=amd64 go build -ldflags "-X github.com/noranetworks/kvds/internal/core.version=$$VERSION" -o tmp/$(BINARY_NAME)
...
RUN GOOS=darwin GOARCH=arm64 go build -ldflags "-X github.com/noranetworks/kvds/internal/core.version=$$VERSION" -o tmp/$(BINARY_NAME)
...
RUN GOOS=linux GOARCH=arm GOARM=6 go build -ldflags "-X github.com/noranetworks/kvds/internal/core.version=$$VERSION" -o tmp/$(BINARY_NAME) -tags rpicamera
...
COPY --from=rpicamera32 /s/internal/protocols/rpicamera/exe/exe internal/protocols/rpicamera/exe/
RUN GOOS=linux GOARCH=arm GOARM=7 go build -ldflags "-X github.com/noranetworks/kvds/internal/core.version=$$VERSION" -o tmp/$(BINARY_NAME) -tags rpicamera
...
RUN GOOS=linux GOARCH=arm64 go build -ldflags "-X github.com/noranetworks/kvds/internal/core.version=$$VERSION" -o tmp/$(BINARY_NAME) -tags rpicamera
